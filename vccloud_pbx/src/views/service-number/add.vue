          ...
          <el-card class="tab-panel" v-loading="loading">
            <el-form ref="form" :model="form" :rules="formRules" label-width="140px" style="max-width: 700px; margin: auto">
              ...
              <div style="margin-left: 140px; padding-bottom: 20px">
                <span style="font-size: 12px"><i style="color: #eb9e05" class="fas fa-exclamation-triangle"></i> Bạn muốn dùng số khác? <a style="color: #1dae94" @click="showResgister = true">Đăng kí ngay!</a></span>
              </div>
...
<script>
  ...
  import ResgisterNumber from '../../components/RegisterNumber/index'
  import InfoNumber from '@/components/Hotline/InfoNumber'

  export default{
    name: 'add-service-number',
